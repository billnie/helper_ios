...
{
    _labTitle = [[UILabel alloc] initWithFrame:CGRectMake(90, 90, kLabelWidth, kLabelHeight)];
    _labTitle.text = [NSString stringWithFormat:@"%i", ++counter];
